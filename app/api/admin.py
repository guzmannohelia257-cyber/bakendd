...
@router.get(
    ...
    description=(
        ...
        "penalización por incumplir el SLA de llegada y minutos de tolerancia."
    ),
)
...
@router.patch(
    ...
    description=(
        "Solo super-admin (rol=4). Actualiza únicamente los campos enviados: "
        "sla_penalizacion_pct (0-100) y/o sla_tolerancia_min (0-600)."
    ),
)
